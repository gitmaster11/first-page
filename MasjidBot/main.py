from telegram.ext import Updater, CommandHandler,filter,MessageHandler,CallbackQueryHandler,ConversationHandler
...
conv_handler = ConversationHandler(
    ...
    states = {
        ...
        "state_get_reyting":[
            CallbackQueryHandler(get_reyting)
        ]
...
token = '5563469644:AAF8Jh5R5ZapEX4S1n3BSGNH8Qx_nuSMJ_0'
